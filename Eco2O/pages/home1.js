...
export default function Home1({ navigation }) {
    ...
    return (
        <View>
          ...
          <Image source={require("../assets/h.jpeg")}
            style={{ width: 110, height: 110 }} />
          <View>
            <Text style={{ marginLeft: 60, marginTop: 30, fontSize: 20, textShadowColor: "#B7B7B7",textShadowOffset: { width: 0, height: 2 }, }}>Welcome in Your Home</Text>
            <Text style={{ marginLeft: 70, marginTop: 0, opacity: 0.6 }}>Choose Your Feature Now</Text>
          </View >
        </View >
        <View>
        <Text style={styles.options}>Options for You</Text>
        </View>
        <ScrollView style={{backgroundColor:"#FFF", alignContent: "center",padding: 10,}}>
